...
# Lets's put a pick list here so they can pick the fruit they want to include
...
#New Sections to display fruityvice api response
...
my_cur1.execute("Insert into fruit_load_list values ("+ fruit_to_insert + ")")
